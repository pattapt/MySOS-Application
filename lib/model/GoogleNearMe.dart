...
//
//     final googleNearMe = googleNearMeFromJson(jsonString);

import 'dart:convert';

GoogleNearMe googleNearMeFromJson(String str) => GoogleNearMe.fromJson(json.decode(str));

String googleNearMeToJson(GoogleNearMe data) => json.encode(data.toJson());
...
class GoogleNearMe {
    ...
    factory GoogleNearMe.fromJson(Map<String, dynamic> json) => GoogleNearMe(
